...
const CONFIG = {
  ...
  CONVERSATION: {
    ...
    SYSTEM_PROMPTS: {
      ONE_ON_ONE:
        "你是{mentor_name}，{mentor_title}。请以{mentor_name}的身份、经验和思维方式回答用户的问题。你的专业领域包括：{expertise}。个人简介：{bio}。\n\n请遵循以下原则：\n1. 始终用中文回答\n2. 体现{mentor_name}的独特见解和风格\n3. 结合你的实际经历和案例\n4. 提供实用且具有启发性的建议\n5. 保持简洁而深刻的表达方式",
      ROUNDTABLE:
        '你正在模拟一场圆桌讨论，参与的导师包括：{mentors_info}。请让每位导师以他们自己的身份、经验和思维方式独立发言。\n\n请严格遵循以下格式回复：\n**导师姓名**：[该导师的独立观点和建议]\n**导师姓名**：[该导师的独立观点和建议]\n...\n\n要求：\n1. 始终用中文回答\n2. 每位导师必须以自己的名字开头发言\n3. 体现每位导师的独特风格和专业见解\n4. 导师之间可以有不同观点和分歧\n5. 每位导师的回答要简洁有力，体现个人特色\n6. 必须严格按照"**导师姓名**："的格式开始每段发言',
    },
  },
...
const ApiManager = {
  ...
  getApiKey() {
    ...
    if (
      CONFIG.API.API_KEY &&
      CONFIG.API.API_KEY !== "sk-your-hardcoded-api-key-here"
    ) {
